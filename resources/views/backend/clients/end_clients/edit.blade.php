        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit End Clients</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body p-4">
                    <h5 class="mb-4">Edit End Client</h5>
                    <form action="{{route('admin.clients.end-clients.update',[Crypt::encrypt($client_id),Crypt::encrypt($data->id)])}}" id="jQueryValidationForm" method="POST">@csrf
                        @method('PUT')
                        <div class="row g-3">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example" style="float: right;">
                            <a href="{{route('admin.clients.end-clients.index',[$client_id])}}" class="btn cancel-button">Cancel</a>
...
@section('javascripts')
    ...
    <script>
        ...
        function prefillData(){
            $('#end_client').val('{{$data->end_client}}');
        }
