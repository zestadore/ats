        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form action="{{route('admin.clients.update',[Crypt::encrypt($data->id)])}}" id="jQueryValidationForm" method="POST">@csrf
                        @method('PUT')
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <x-forms.input class="form-control {{ $errors->has('poc') ? ' is-invalid' : '' }}" title="PoC" name="poc" id="poc" type="text" value="{{$data->poc}}" required="False"/>
                            </div>
                        </div><p> </p>
                        <div class="row g-3">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example" style="float: right;">
                            <a href="{{route('admin.clients.index')}}" class="btn cancel-button">Cancel</a>
