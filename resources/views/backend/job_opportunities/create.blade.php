        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add New Job Opportunity</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body p-4">
                    <h5 class="mb-4">Add New Job Opportunity</h5>
                    <form action="{{route('admin.job-opportunities.store')}}" id="jQueryValidationForm" method="POST">@csrf
                        <div class="row g-3">
