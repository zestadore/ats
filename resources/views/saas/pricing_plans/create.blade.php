        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add New Pricing Plans</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form action="{{route('admin.pricing-plans.store')}}" id="jQueryValidationForm" method="POST">@csrf
                        <div class="row g-3">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example" style="float: right;">
                            <a href="{{route('admin.pricing-plans.index')}}" class="btn cancel-button">Cancel</a>
