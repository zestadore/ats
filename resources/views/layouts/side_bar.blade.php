    ...
    <ul class="list-unstyled">
          ...
          @canany(['isAdmin'])
            <li class="sidebar-list-item"><a class="sidebar-link text-muted {{ (request()->is('admin/site-settings*')|| request()->is('admin/mail-settings*')|| request()->is('admin/pricing-plans/*')|| request()->is('admin/companies*'))? 'active' : '' }}" href="#" data-bs-target="#saasDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
              <i class="fa fa-cubes" style="font-size:15px;padding:5px;"></i>&nbsp;<span class="sidebar-link-title">&nbsp;SaaS </span></a>
          ...
          @canany(['isAdmin','isAccountManager','isTeamLead','isCompanyAdmin'])
            <li class="sidebar-list-item"><a class="sidebar-link text-muted {{ (request()->is('admin/users*'))? 'active' : '' }}" href="{{route('admin.users.index')}}"><i class="fa fa-users" style="font-size:15px;padding:5px;"></i>&nbsp;Users</a></li>
            ...
            <li class="sidebar-list-item"><a class="sidebar-link text-muted {{ (request()->is('admin/clients*'))? 'active' : '' }}" href="{{route('admin.clients.index')}}"><i class="fa fa-user-secret" style="font-size:15px;padding:5px;"></i>&nbsp;Clients</a></li>
          ...
          @endcanany
          <li class="sidebar-list-item"><a class="sidebar-link text-muted {{ (request()->is('admin/candidates*'))? 'active' : '' }}" href="{{route('admin.candidates.index')}}"><i class="fa fa-user-plus" style="font-size:15px;padding:5px;"></i>&nbsp;Candidates</a></li>
          ...
          <li class="sidebar-list-item"><a class="sidebar-link text-muted {{ (request()->is('admin/job-opportunities*'))? 'active' : '' }}" href="{{route('admin.job-opportunities.index')}}"><i class="fa fa-tags" style="font-size:15px;padding:5px;"></i>&nbsp;Job Opportunities</a></li>
          ...
          <li class="sidebar-list-item"><a class="sidebar-link text-muted {{ (request()->is('admin/job-submissions*'))? 'active' : '' }}" href="{{route('admin.job-submissions.index')}}"><i class="fa fa-rocket" style="font-size:15px;padding:5px;"></i>&nbsp;Job Submissions</a></li>
          ...
          <li class="sidebar-list-item"><a class="sidebar-link text-muted {{ (request()->is('admin/interviews*'))? 'active' : '' }}" href="{{route('admin.interviews.index')}}"><i class="fa fa-podcast" style="font-size:15px;padding:5px;"></i>&nbsp;Interviews</a></li>
          ...
          <li class="sidebar-list-item"><a class="sidebar-link text-muted {{ (request()->is('admin/invoices*'))? 'active' : '' }}" href="{{route('admin.invoices.index')}}"><i class="fa fa-file-pdf-o" style="font-size:15px;padding:5px;"></i>&nbsp;Invoices</a></li>
